...
import AssignAlertForm from "../forms/AssignAlertForm";
...
const AssignAlertModal: React.FC<TenantModalProps> = ({ onClose }) => {
  ...
  return (
    <>
      {step === 1 && <AssignAlertForm onNext={nextStep} onClose={onClose} />}
