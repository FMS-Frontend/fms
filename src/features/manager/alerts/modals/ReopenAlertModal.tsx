...
import ReopenAlertForm from "../forms/ReopenAlertForm";
...
const ReopenAlertModal: React.FC<TenantModalProps> = ({ onClose }) => {
  ...
  return (
    <>
      {step === 1 && <ReopenAlertForm onNext={nextStep} onClose={onClose} />}
...
export default ReopenAlertModal;
