...
const UpdateAlertModal: React.FC<TenantModalProps> = ({ onClose, alertId }) => {
    ...
    return (
        <>
            <UpdateAlertForm onClose={onClose} alertId={alertId} tenantId={tenant} alertDetails={alertById} />
        </>
    )
